  ...
  return (
    <View className="flex items-center justify-center relative">
      ...
      <View className=" flex items-center justify-center absolute top-[90px]">
        ...
        <Text className={`text-18 font-helvetica-light my-[2px] ${textLight0Dark500}`}>({props.nickName})</Text>
        <Text className={`text-16 font-helvetica-light my-[2px] ${textLight0Dark500}`}>{props.description}</Text>
